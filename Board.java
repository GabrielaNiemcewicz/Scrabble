...
//do we use refresh each square, or refresh 
	...
	public void placeWordVertically(Frame frame, int firstPosition_x, int firstPosition_y, String word, Player player) { //in main: board.placeWordVertically(frame.someGetterFunction()) //best get all Tiles needed, get one Tile ok
	...
	public void placeWordHorizontally(Frame frame, int firstPosition_x, int firstPosition_y, String word, Player player) { //in main: board.placeWordVertically(frame.someGetterFunction()) //best get all Tiles needed, get one Tile ok
		ArrayList<Tile> tilesFromFrame = new ArrayList<Tile>();
		String onlyNeededLetters = "";
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
	...
	public boolean connectsToTiles(ArrayList<Square> validationTestsScope) { //make a list of square walkers and loop through that list
		if (this.isFirstWord())
			return true;
	...
	private int returnScore (int firstPositionX, int firstPositionY, boolean isHorizontal, String word)
	{
		int score = 0;
	...
	public void challengeWord (int firstPositionX, int firstPositionY, boolean isHorizontal, int wordLength, Player player2, String word) {
	//substracting score of bad word in other player than is used in the round
	int score = this.returnScore(firstPositionX, firstPositionY, isHorizontal, word);
